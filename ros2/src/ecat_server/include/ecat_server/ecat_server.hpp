...
private:
	...
	rclcpp::Publisher<ecat_interfaces::msg::MasterConfiguration>::SharedPtr _master_configuration_publisher;
	rclcpp::Publisher<ecat_interfaces::msg::SlaveStatus>::SharedPtr _slave_status_publisher;
	rclcpp::Publisher<ecat_interfaces::msg::SlaveConfiguration>::SharedPtr _slave_configuration_publisher;
	...
	rclcpp::Service<ecat_interfaces::srv::GetSlaveConfiguration>::SharedPtr _get_slave_configuration_service;
	rclcpp::Service<ecat_interfaces::srv::GetSlaveConfigurations>::SharedPtr _get_slave_configurations_service;
	rclcpp::Service<ecat_interfaces::srv::SetSlaveConfiguration>::SharedPtr _set_slave_configuration_service;
	...
	rclcpp::Service<ecat_interfaces::srv::GetMasterConfiguration>::SharedPtr _get_master_configuration_service;
	rclcpp::Service<ecat_interfaces::srv::SetMasterConfiguration>::SharedPtr _set_master_configuration_service;
